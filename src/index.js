var colorNames = require("./webColors.json");
// ------------ main converter ---------------------------- //
...
function convertNameToHex(color) {
    ...
    var index = Object.keys(colorNames).indexOf(color);
...
function convertRGBToHex(color) {
    ...
    var hex = color.map(function (v) {
        var converted = v.toString(16);
...
function convertHexToName(color) {
    ...
    var index = Object.values(colorNames).indexOf(color);
...
function convertHexToRGB(color) {
    ...
    var values = color.slice(1).match(/.{1,2}/g);
    var rgb = values.map(function (v) {
...
module.exports = {
    convert: convert,
    convertNameToHex: convertNameToHex,
    convertRGBToHex: convertRGBToHex,
    convertHexToName: convertHexToName,
