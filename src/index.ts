...
// ------------ main converter ---------------------------- //
function convert(color: any, input: string, output: any): any {
  let hex;
...
function convertNameToHex(color: any): any { // string
...
function convertRGBToHex(color: any): any { // string
...
// ------- convert FROM hex --------------------- //
function convertHexToName(color: any): any { // name
...
function convertHexToRGB(color: any): any { // array
  color = validHex(color);
...
// ----------------- type validators ------------------------------ //
function validHex(color: any): any { // string
...
function validRGB(color: any): any { // array
  // check is array
...
function validName(color: any): any { // string
  // check type is string
  if (typeof color !== "string") {
